...
Hitable *twoSpheres() {
    vector<Hitable *> list;
    Texture *pertext = new SmoothNoiseTexture(4);
    list.push_back(new Sphere({0, -1000, 0}, 1000, new Lambertian(pertext)));
    list.push_back(new Sphere({0, 2, 0}, 2, new Lambertian(pertext)));
...
int main() {
    ...
    int ny = 200;
    int ns = 10;
    ofstream fout("test_perlin_3.ppm");
