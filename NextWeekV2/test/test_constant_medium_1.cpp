...
//    list.push_back(new Cube({265, 0, 295}, {430, 330, 460}, white));
    ...
    list.push_back(new ConstantMedium(cube1, new ConstantTexture({1, 1, 1}), 0.01));
    list.push_back(new ConstantMedium(cube2, new ConstantTexture({0, 0, 0}), 0.01));
...
int main() {
    ...
    ny = 720;
    ns = 100;
    ofstream fout("test_constant_medium_1.ppm");
